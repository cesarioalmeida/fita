...
public class AccountServiceTests : ContainerFixture
{
    ...
    public async Task CalculateBalance_AccountNoTransactions_ReturnsInitialBalance()
    {
        ...
        Assert.Equals(10m, await _accountService.CalculateBalance(account, null));
    }
    ...
    public async Task CalculateBalance_OnlyDepositTransactions_ReturnsBalance()
    {
        ...
        Assert.Equals(25m, await _accountService.CalculateBalance(account, transactions));
    }
    ...
    public async Task CalculateBalance_OnlyPaymentTransactions_ReturnsBalance()
    {
        ...
        Assert.Equals(2m, await _accountService.CalculateBalance(account, transactions));
    }
    ...
    public async Task CalculateBalance_MixTransactions_ReturnsBalance()
    {
        ...
        Assert.Equals(5m, await _accountService.CalculateBalance(account, transactions));
    }
    ...
    {
        Assert.Equals(10m, await _accountService.CalculateBalance(null, 10m));
    }
    ...
    public async Task CalculateBalance_DepositTransaction_ReturnsBalance()
    {
        ...
        Assert.Equals(12m, await _accountService.CalculateBalance(transaction, 10m));
    }
    ...
    public async Task CalculateBalance_PaymentTransaction_ReturnsBalance()
    {
        ...
        Assert.Equals(8m, await _accountService.CalculateBalance(transaction, 10m));
    }
}