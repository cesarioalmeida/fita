...
public class TransferDetailsViewModel : ComposedDocumentViewModelBase, IDesiredSize, IHasSaved
{
    ...
    public async Task RefreshData()
    {
        ...
        try
        {
            ...
            {
                OtherTransaction = await TransactionRepoService.GetSingle(Transaction.TransferTransactionId, true);
    ...
    public async Task Save()
    {
        ...
        try
        {
            ...
            if (await TransactionRepoService.Save(Transaction) == Result.Success &&
                await TransactionRepoService.Save(OtherTransaction) == Result.Success)
            {
